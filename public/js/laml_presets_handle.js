...
$("#voice_mail").on("click", function () {
  selection_input.value = "voice";
  text_res = prompt(
    "Enter what you'd like it to say.",
...
$("#sms_simple").on("click", function () {
  ...
  if (
    confirm(
      `Please note: Any SMS & MMS sent into or from the United States must have a campaign. if you want to learn more, please press "OK"`
    )
  ) {
    window.open(
      "https://developer.signalwire.com/apis/docs/campaign-registry-all-you-need-to-know",
      "_blank"
    );
    laml_box.textContent = `<?xml version="1.0" encoding="UTF-8"?>
<Response>
...
$("#message_forward").on("click", function () {
  ...
  if (
    ...
    number_message = prompt(
      "Please enter your desired phone number. Please note: This uses E164 Format.",
      "+18151004302"
    );
    window.open(
      "https://developer.signalwire.com/apis/docs/campaign-registry-all-you-need-to-know",
